<template>
	<div class="site-shell">
		<div class="grid gap-12">
			<div
				class="relative min-h-64 overflow-hidden rounded-2xl sm:min-h-54 lg:min-h-48"
			>
				<SkeletonImage
					:src="linksBannerImage"
					alt=""
					class="absolute inset-0 w-full"
					image-class="block h-64 w-full object-cover transition-opacity duration-200 sm:h-54 lg:h-48"
				/>
				<div
					class="absolute inset-0 z-10 flex min-h-64 flex-col justify-between px-6 py-6 text-white sm:min-h-54 lg:min-h-48 lg:flex-row lg:items-center lg:gap-5 lg:px-8"
				>
					<p
