...
interface AdminDatePartsFieldProps {
	minYear?: number
	allowEmpty?: boolean
}

const props = withDefaults(defineProps<AdminDatePartsFieldProps>(), {
	minYear: 1900,
	allowEmpty: true,
})
const model = defineModel<string>({ required: true })
const { t } = useI18n()
const dateParts = reactive<AdminDateParts>({
	year: '',
	month: '',
	day: '',
})
