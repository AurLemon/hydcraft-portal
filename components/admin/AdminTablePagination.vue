<template>
	...
	>
		<div class="text-slate-500 dark:text-slate-400">
			{{ t('admin.pagination.summary', { page, pageCount, total }) }}
		</div>
...
const props = defineProps<AdminTablePaginationProps>()
...
const pageSizeItems = computed(() => [
	{ label: t('admin.pagination.pageSize', { size: 10 }), value: 10 },
	{ label: t('admin.pagination.pageSize', { size: 20 }), value: 20 },
	{ label: t('admin.pagination.pageSize', { size: 50 }), value: 50 },
	{ label: t('admin.pagination.pageSize', { size: 100 }), value: 100 },
])
