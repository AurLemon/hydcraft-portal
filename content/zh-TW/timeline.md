...
再後來，HydCraft 開始需要一個遊戲外的入口。2021 年 3 月，Wiki 用來讓玩家自由記錄與補充內容；2024 年 7 月，Docs 用來整理文件與說明；2024 年 8 月，狀態監控用來查看伺服器是否正常運行；2026 年，Portal 用來作為統一入口。玩家資料、帳號綁定、身份系統、伺服器狀態、地圖入口和歷史記錄，也讓 HydCraft 從單純的 MC 存檔，慢慢變成一個更完整的社群系統。
